...
def create_folders_for_range (start:2020, end:2024):
      """ Creates folders for a given years range """
...
def create_prefixed_folders(folder_list, prefix):
      """ Creates prefixed folders by transforming a list of names and combining each with a prefix """
...
list = ['Data-MD', 'Data-VA', 'Data-AZ', 'Data-DE', 'Data-WV', 'Data-MA', 'Data-VT', 'Data-ME']
for item in list:
